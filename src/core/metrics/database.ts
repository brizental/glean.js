...
class MetricsDatabase {
  ...
  constructor() {
    this.userStore = new Glean.platform.store("userLifetimeMetrics");
    this.pingStore = new Glean.platform.store("pingLifetimeMetrics");
    this.appStore = new Glean.platform.store("appLifetimeMetrics");
  }
